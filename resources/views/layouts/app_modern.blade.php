            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('/kelas.index') ? 'active' : '' }}"
                                href="/kelas.index" aria-expanded="false">
                                <span>
                                    <i class="ti ti-layout-dashboard"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('/daftar/create') ? 'active' : '' }}"
                                href="/daftar/create" aria-expanded="false">
                                <span>
                                    <i class="ti ti-layout-dashboard"></i>
                                </span>
    ...
    <script>
        $(document).ready(function() {
            $('.select2').select2({
                ...
                allowClear: true,
                width: 'resolve' // Mengatur lebar otomatis mengikuti element
            });
        });
    </script>
</body>
